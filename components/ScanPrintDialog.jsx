...
const ScanPrintDialog = () => {
  ...
  return (
    <Portal>
      <Dialog visible={!selectedPrinter} dismissable={false} style={styles.dialog}>
        <Dialog.Title>Connect to Printer</Dialog.Title>
        <Dialog.Content>
          <Text style={{ marginBottom: 10 }}>
            Please connect to a Bluetooth printer before proceeding.
          </Text>
          ...
          {selectedPrinter && (
            <>
              ...
              <View style={styles.printActionsContainer}>
                ...
                <TouchableOpacity style={styles.printButton} onPress={printImage}>
...
export default ScanPrintDialog;
